...
public class UserProviderController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyAuthority('PERM_provider.users:read')")
    public ResponseEntity<?> fetchAllUsers(
        ...
        TableDTO users = userService.getAllProviderUsers(page, size, sort, dir, q);
    ...
    /*@PostMapping
    @PreAuthorize("hasAnyAuthority('PERM_provider.users:create')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('PERM_provider.users:update')")
    public ResponseEntity<?> updateUser(
        ...
        try {
            ...
            audit(currentUser, httpReq, "USER", id, "USER_UPDATE", null, updatedUser);
